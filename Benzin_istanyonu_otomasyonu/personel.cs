...
namespace Benzin_istanyonu_otomasyonu
{
    public partial class personel : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            OleDbCommand kmt;
            baglan.Open();
            kmt = new OleDbCommand("Delete from personel where tc = '" + dataGridView1.CurrentRow.Cells[1].Value.ToString() + "'", baglan);
            kmt.ExecuteNonQuery();
            kmt.Dispose();
            baglan.Close();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            OleDbCommand kmt;
            baglan.Open();
            kmt = new OleDbCommand("UPDATE personel SET tc='" + maskedTextBox3.Text + "',adi_soyadi='" + textBox1.Text + "',dogum_tarihi='" + maskedTextBox1.Text + "',tel='" + maskedTextBox2.Text + "',email='" + textBox2.Text + "',pozisyon='" + comboBox1.Text + "',maas='" + textBox3.Text + "'where tc='" + dataGridView1.CurrentRow.Cells[1].Value.ToString() + "'", baglan);
            kmt.ExecuteNonQuery();
            baglan.Close();
            MessageBox.Show("İşleminiz başarılı");
            listele();
